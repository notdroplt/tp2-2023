...
class Star {
	...
	constructor(mass, coordinate) {
		...
		let color = "#ff0000";
		if (temperature > 30000) color = "#3333ff";
		else if (temperature > 10000) color = "#cccccc";
		else if (temperature > 7500) color = "#eeee99";
		else if (temperature > 6000) color = "#f3f322";
		else if (temperature > 5000) color = "#ff7000";
